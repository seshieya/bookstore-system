...
public class PurchaseReader extends Reader {
	...
	public static Map<Long, Purchase> read() throws ApplicationException {
		...
		// this commented out code was used to create the purchases file
		// Formatter formatter = null;
		//
		// try {
		// formatter = new Formatter(new File("x.csv"));
		...
		for (CSVRecord record : records) {
			...
			// formatter.format("%d,%d,%d,%.2f%n", id, customerId, bookId, price);
		}
